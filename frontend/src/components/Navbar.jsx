...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        ...
        </div>: <button onClick={()=>navigate('/login')} className='text-white  bg-primary px-4 py-3 rounded-full  hidden md:block'>Create Account</button>}
